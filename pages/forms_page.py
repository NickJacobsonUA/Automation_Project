...
class FormPage(BasePage):
    ...
    def fill_form_fields(self):
        person = next(generated_person()) # нужен генератор людей
        file_name, path = generated_file() # загрузка файла также нужна на странице
        # после нужно просто заполнить и отправить страницу
        self.remove_footer()
